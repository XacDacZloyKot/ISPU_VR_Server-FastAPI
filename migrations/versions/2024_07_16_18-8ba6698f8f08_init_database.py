...
Revision ID: 8ba6698f8f08
Revises: 
Create Date: 2024-07-16 18:39:00.429457
...
def upgrade() -> None:
    ...
    op.create_table('location',
                    ...
                    sa.Column('status', sa.Enum('DEVELOPING', 'INACTIVE', 'COMPLETED', name='locationstatus'),
                              nullable=False),
                    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table('model',
                    ...
                    sa.ForeignKeyConstraint(['parameters_id'], ['parameters.id'],
                                            name=op.f('fk_model_parameters_id_parameters')),
                    sa.ForeignKeyConstraint(['sensor_type_id'], ['sensortype.id'],
                                            name=op.f('fk_model_sensor_type_id_sensortype')),
    ...
    op.create_table('location_model_association',
                    ...
                    sa.ForeignKeyConstraint(['location_id'], ['location.id'],
                                            name=op.f('fk_location_model_association_location_id_location')),
                    sa.ForeignKeyConstraint(['model_id'], ['model.id'],
                                            name=op.f('fk_location_model_association_model_id_model'))
                    )
    op.create_table('model_accident_association',
                    sa.Column('model_id', sa.Integer(), nullable=True),
                    sa.Column('accident_id', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['accident_id'], ['accident.id'],
                                            name=op.f('fk_model_accident_association_accident_id_accident')),
                    sa.ForeignKeyConstraint(['model_id'], ['model.id'],
                                            name=op.f('fk_model_accident_association_model_id_model'))
                    )
    op.create_table('scenario',
                    ...
                    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
                    sa.ForeignKeyConstraint(['location_id'], ['location.id'],
                                            name=op.f('fk_scenario_location_id_location')),
    ...
    op.create_table('admission',
                    ...
                    sa.Column('status',
                              sa.Enum('INACTIVE', 'ACTIVE', 'COMPLETED', 'EXAMINATION', name='admissionstatus'),
                              nullable=False),
                    sa.Column('user_id', sa.Integer(), nullable=False),
                    sa.Column('scenario_id', sa.Integer(), nullable=False),
                    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
                    sa.ForeignKeyConstraint(['scenario_id'], ['scenario.id'],
                                            name=op.f('fk_admission_scenario_id_scenario')),
    ...
    op.create_table('scenario_accident_association',
                    ...
                    sa.Column('accident_id', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['accident_id'], ['accident.id'],
                                            name=op.f('fk_scenario_accident_association_accident_id_accident')),
                    sa.ForeignKeyConstraint(['scenario_id'], ['scenario.id'],
                                            name=op.f('fk_scenario_accident_association_scenario_id_scenario'))
                    )
