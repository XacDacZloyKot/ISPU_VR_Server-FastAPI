...
def upgrade() -> None:
    ...
    sa.Column('KKS', sa.String(length=64), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    ...
    op.create_table('sensor_location_association',
    sa.Column('sensor_id', sa.Integer(), nullable=True),
    sa.Column('location_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['location_id'], ['location.id'], name=op.f('fk_sensor_location_association_location_id_location')),
    sa.ForeignKeyConstraint(['sensor_id'], ['sensor.id'], name=op.f('fk_sensor_location_association_sensor_id_sensor'))
    )
...
def downgrade() -> None:
    ...
    op.drop_table('sensor_location_association')
